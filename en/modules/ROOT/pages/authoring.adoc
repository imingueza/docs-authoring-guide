...
[#where-are-files]
== Where files are placed in a repository

All our document repositories have the same structure.
The following figure shows the folder hierarchy and where each type of file is placed:
