...
There are a number of extensions that can be easily installed and will greatly improve your Asciidoc editing process.
...
This one is mandatory to automatically keep some conventions across authors (e.g. use Unix-style line endings).
...
image::vscode-asciidoc-preview-selection.png[]
